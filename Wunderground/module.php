        ...
        protected function SetValueByID($VariablenID,$Wert)
            {
                ...
                if(AC_GetLoggingStatus($archiveHandlerID , $VariablenID) ==true){
                    ...
                    if (($LastValue-$Wert+1)/$LastValue <= 7  && ($LastValue-$Wert+1)/$LastValue >= -7){            //Wenn der neue Wert nicht um +-700% größer/kleiner ist, schreibe den neuen Wert in die Variable
