...
privat function Var_Pro_ersellen($name,$ProfileType,$Suffix,$MinValue,$MaxValue,$StepSize,$Digits,$Icon)
...
privat function Var_Pro_WD_WindSpeed.kmh()
...
privat function Var_Pro_WD_UV_Index()
