        ...
        protected function SetValueByID($VariablenID,$Wert)
            {
                ...
                if(AC_GetLoggingStatus($archiveHandlerID , $VariablenID) ==true){
                    ...
                    if (($LastValue-$Wert+0,001)/$LastValue <= 7  && ($LastValue-$Wert)/$LastValue >= -7){            //Wenn der neue Wert nicht um +-700% größer/kleiner ist, schreibe den neuen Wert in die Variable
